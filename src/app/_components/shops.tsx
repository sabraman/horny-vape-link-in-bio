...
export function Shops() {
	...
	return (
		<div className="flex flex-col gap-4">
			<h2 className="text-center text-4xl font-bold uppercase  text-gray-50">
				Наши магазины
			</h2>
			<ShopsCarousel />
			{shops.map((shop) => (
				...
				>
					<DrawerTrigger
						className={cn(
							`${shop.color[0]}`,
							`${shop.color[1]}`,
							"inline-flex h-auto  items-center justify-center rounded-md px-6  py-3 text-xl font-bold uppercase text-gray-50 transition-colors focus:outline-none focus:ring-1 focus:ring-gray-300",
						)}
					>
						{/* <Button
					...
					<DrawerContent>
						...
						<DrawerFooter>
							...
							<div className="inline-flex w-full items-center justify-between gap-2">
								...
								<Link
									href={`tel:${shop.phone}`}
									className="inline-flex h-12 w-12 items-center justify-center rounded-md border-2 border-gray-800 bg-gray-950 px-3  uppercase text-gray-50 transition-colors hover:bg-gray-800 hover:text-gray-50 focus:outline-none focus:ring-1 focus:ring-gray-300"
									target="_blank"
								>
									<Phone />
								</Link>
